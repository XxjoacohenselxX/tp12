...
func main() {
	...
	for {
		...
		fmt.Println("2. Leer registro por ID")
		fmt.Println("3. Leer todos los registros")
		fmt.Println("4. Actualizar registro")
		fmt.Println("5. Borrar registro")
		fmt.Println("6. Borrar todos los registros")
		fmt.Println("7. Salir")
